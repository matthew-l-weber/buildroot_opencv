...
#
################################################################################
TI_LINUXUTILS_VERSION:=3_21_00_04
TI_LINUXUTILS_FILE_VERSION:=$(TI_LINUXUTILS_VERSION)
...
TI_LINUXUTILS_DIR:=$(BUILD_DIR)/linuxutils_$(TI_LINUXUTILS_VERSION)

TI_LINUXUTILS_INSTALL_STAGING = YES

TI_LINUXUTILS_INSTALL_STAGING_DIR=$(STAGING_DIR)/ti/linuxutils_$(TI_LINUXUTILS_VERSION)

TI_LINUXUTILS_DEPENDENCIES=linux26
...
#broken TI_LINUXUTILS_MODULES += sdma
endif
...
define TI_LINUXUTILS_BUILD_CMDS
 ...
 $(MAKE) $(TI_LINUXUTILS_BUILD_MAKE_ARGS) -C $(@D)/packages/ti/sdo/linuxutils/$$i ; \
 done
endef
...
define TI_LINUXUTILS_INSTALL_TARGET_CMDS
 ...
 for i in $(TI_LINUXUTILS_MODULES) ; do \
 $(INSTALL) -m 0644 $(@D)/packages/ti/sdo/linuxutils/$$i/src/module/$${i}k.ko $(TARGET_DIR)/lib/modules/$(LINUX26_VERSION_PROBED)/kernel/drivers/dsp/$${i}k.ko ; \
