...
#
################################################################################
TI_LOCAL_POWER_MANAGER_VERSION:=1_24_03_11
TI_LOCAL_POWER_MANAGER_FILE_VERSION:=$(TI_LOCAL_POWER_MANAGER_VERSION)
...
TI_LOCAL_POWER_MANAGER_DIR:=$(BUILD_DIR)/local_power_manager_linux_$(TI_LOCAL_POWER_MANAGER_VERSION)

TI_LOCAL_POWER_MANAGER_INSTALL_STAGING = YES

TI_LOCAL_POWER_MANAGER_DEPENDENCIES = ti-xdctools ti-dsplink linux26

TI_LOCAL_POWER_MANAGER_INSTALL_STAGING_DIR=$(STAGING_DIR)/ti/local_power_manager_linux_$(TI_LOCAL_POWER_MANAGER_VERSION)
